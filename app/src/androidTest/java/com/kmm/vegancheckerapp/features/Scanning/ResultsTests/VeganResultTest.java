...
public class VeganResultTest {


    String[] ingredz = {""};
    User user = new User();
    Product product = new Product(1, "Demi Baguette (140g)", "Aldi," , "5099406002126", "Bread", "In Store Bakery", ingredz, "Vegan", "Aldi (2020)", user, "Food" );
   ...
   String ingredients = "Ingredients: Vegan*";
    String validatedBy = "*Validated By: " + product.getValidatedBy();
 ...
 /*
    ...
    static {
        ...
        intent.putExtra("RESULT" , "5099406002126");
    ...
    public void textViewTest(){
        ...
        onView(withId(R.id.tvValidatedBy)).check(matches(withText(validatedBy)));
