...
public class NonVeganResultTests {


    String[] ingredz = {"beef", "cheese"};
    Product product = new Product(1, "4 Irish Mega Beef Burgers", "", "0101010101", "Burger", "Dunnes Stores", ingredz, "No", "", null, "Food" );
    String name = product.getProductBrand() + " " + product.getProductName();
    String production ="Production: Not Vegan";
    String ingredients ="Ingredients: Not Vegan";
    String result = "0% Vegan";
    String ingredient = ingredz[0];
    String contains = "Contains: " + ingredient;
  ...
  /*
    ...
    static {
        ...
        intent.putExtra("RESULT" , "5099874093503");
